...
public class IUpdateExampleUseCase implements IUpdateUseCase<Example> {
  @Override
  public void preLoad(
          long id, Object o, ICrudService<Example> service, JpaRepository<Example, Long> repository) {/* implement */}

  @Override
  public void preUpdate(
          Example example, Object o, ICrudService<Example> service, JpaRepository<Example, Long> repository) {/* implement */}
